<template>
    ...
    <div v-else>
        ...
        <div class="w-full mt-6">
            <UCard class="flex gap-4 justify-center flex-col w-full">
                <div class="flex w-full items-center mt-4 gap-2 text-xl mb-4">
                    Qurilma quvvati battariyasi haqida ma'lumot
                </div>
                ...
                <div class="flex mt-5 justify-around">
                    <linechart :monthlyData="data" label="Oylik battariyasi darajasi" color="blue"
                        backgroundColor="rgba(0,0,255,0.2)" yText="Zaryad miqdori" xText="Kun tartibi" />
                </div>
            </UCard>
        ...
        <div class="w-full mt-6">
            <UCard class="flex gap-4 justify-center flex-col w-full">
                <div class="flex w-full items-center mt-4 gap-2 text-xl mb-4">
                    Qurilma zaryad olishi haqida ma'lumot
                </div>
                ...
                <div class="flex mt-5 justify-around">
                    <linechart :monthlyData="data1" label="Oylik battariyasi  quvvati darajasi" color="blue"
                        backgroundColor="rgba(55,0,155,0.2)" yText="Quvvat miqdori (V)" xText="Kun tartibi" />
                </div>
            </UCard>
