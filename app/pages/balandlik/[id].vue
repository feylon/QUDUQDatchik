    ...
    <div v-else>
        ...
        <div class="w-full mt-6">
            <UCard class="flex gap-4 justify-center flex-col w-full">
                <div class="flex w-full items-center mt-4 gap-2 text-xl mb-4">
                             Suvning balandligi haqida ma'lumot
                ...
                <div class="flex mt-5 justify-around">
                    <linechart :monthlyData="data" label="Oylik suv balandligi darajasi" color="blue"
                        backgroundColor="rgba(0, 150, 255, 0.4)" yText="Balandlik miqdori" xText="Kun tartibi" />
                </div>
            </UCard>
        ...
        <div class="w-full mt-6">
            <UCard class="flex gap-4 justify-center flex-col w-full">
                ...
                <div class="flex mt-5 justify-around">
                    <linechart :monthlyData="data1" label="Suvning hajm miqdori" color="blue"
                        backgroundColor="rgba(0, 150, 255, 0.4)" yText="Suv miqdori (m &sup3;)" xText="Kun tartibi" />
                </div>
            </UCard>
